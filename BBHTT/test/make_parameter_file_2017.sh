...
# SUSY_bbH
./split_filelist.sh analysisMacroSynch_${CHANNEL}_17_MC.conf SUSYGluGluToBBHToTauTau_powheg_M125 5


#SUSY_ggH
./split_filelist.sh analysisMacroSynch_${CHANNEL}_17_MC.conf SUSYGluGluToHToTauTau_powheg_M125 5
