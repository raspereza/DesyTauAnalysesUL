...
#bbH SUSY sample for mass 125GeV
ls $dirMC2/SUSYGluGluToBBHToTauTau_powheg_M125/*root > $OUTDIR/SUSYGluGluToBBHToTauTau_powheg_M125

#ggH SUSY sample for mass 125 GeV
ls $dirMC2/SUSYGluGluToHToTauTau_powheg_M125/*root > $OUTDIR/SUSYGluGluToHToTauTau_powheg_M125
