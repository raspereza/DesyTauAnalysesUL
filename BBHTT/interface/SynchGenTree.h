...
#ifndef SynchGenTree_h
#define SynchGenTree_h
...
//gen vertex info is practical to have
  ...
  //ranches for the tau decay product constituent vx etc.
...
TBranch        *b_mix0p375_htt125;
  SynchGenTree(TTree *tree=0);
  virtual ~SynchGenTree();
